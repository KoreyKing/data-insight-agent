...
export const Ico: Record<string, (p: IconProps) => JSX.Element> = {
  ...
  ThumbUp: (p) => (<svg viewBox="0 0 16 16" width={p.size || 13} height={p.size || 13} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M2.5 7h2.5v6.5H2.5z" /><path d="M5 7l2.6-4.8c.9 0 1.6.8 1.4 1.7L8.6 6H12.5a1.3 1.3 0 0 1 1.3 1.6l-1 4.8a1.4 1.4 0 0 1-1.4 1.1H5" /></svg>),
  ThumbDown: (p) => (<svg viewBox="0 0 16 16" width={p.size || 13} height={p.size || 13} fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><g transform="rotate(180 8 8)"><path d="M2.5 7h2.5v6.5H2.5z" /><path d="M5 7l2.6-4.8c.9 0 1.6.8 1.4 1.7L8.6 6H12.5a1.3 1.3 0 0 1 1.3 1.6l-1 4.8a1.4 1.4 0 0 1-1.4 1.1H5" /></g></svg>),
}
